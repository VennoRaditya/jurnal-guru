        ...
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            ...
            <div class="flex flex-col sm:flex-row items-center gap-3 w-full lg:w-auto">
                ...
                <div class="flex gap-2 w-full sm:w-auto">
                    ...
                    <a href="{{ route('guru.absensi.rekapPdf', ['bulan_tahun' => $periodeInput, 'kelas' => request('kelas')]) }}" target="_blank"
                        class="flex-1 sm:flex-none bg-slate-900 text-white px-5 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-indigo-600 transition-all flex items-center justify-center gap-2 shadow-lg shadow-slate-200">
...
<script>
    ...
    function openEditModal(id, nama, status) {
        ...
        // Memastikan route update terbentuk dengan benar
        const baseUrl = "{{ url('guru/siswa/absensi/rekap/update') }}";
        ...
        // RequestAnimationFrame untuk animasi yang lebih smooth
